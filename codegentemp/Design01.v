...
// VDAC8_v1_90(Data_Source=0, Initial_Value=207, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=2, Voltage=3312, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC8_1, CY_INSTANCE_SHORT_NAME=VDAC8_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=VDAC8_1, )
...
module top ;
	...
	cy_clock_v1_0
		#(.id("0e503c2d-215d-4567-a08b-e1fe28669733"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000"),
		  .is_direct(0),
    ...
    UART_v2_50_0 UART_1 (
        ...
        .reset(1'b0),
        .rx(Net_489),
        .tx_interrupt(Net_490),
        .rx_interrupt(Net_491),
        .tx_data(Net_492),
        .tx_clk(Net_493),
        .rx_data(Net_494),
        .rx_clk(Net_495));
	...
	wire [0:0] tmpOE__REDY_net;
	wire [0:0] tmpIO_0__REDY_net;
	wire [0:0] tmpINTERRUPT_0__REDY_net;
	electrical [0:0] tmpSIOVREF__REDY_net;

	cy_psoc3_pins_v1_10
		#(.id("8998a4cf-4b27-4015-a168-8f9a2d789aef"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		REDY
		 (.oe(tmpOE__REDY_net),
		  .y({1'b0}),
		  .fb({Net_622}),
		  .io({tmpIO_0__REDY_net[0:0]}),
		  .siovref(tmpSIOVREF__REDY_net),
		  .interrupt({tmpINTERRUPT_0__REDY_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__REDY_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Intr_net;
	wire [0:0] tmpFB_0__Intr_net;
	wire [0:0] tmpIO_0__Intr_net;
	wire [0:0] tmpINTERRUPT_0__Intr_net;
	electrical [0:0] tmpSIOVREF__Intr_net;

	cy_psoc3_pins_v1_10
		#(.id("671364d6-da3e-4438-a3be-41c2c176e0b0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Intr
		 (.oe(tmpOE__Intr_net),
		  .y({Net_655}),
		  .fb({tmpFB_0__Intr_net[0:0]}),
		  .io({tmpIO_0__Intr_net[0:0]}),
		  .siovref(tmpSIOVREF__Intr_net),
		  .interrupt({tmpINTERRUPT_0__Intr_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Intr_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam VDAC8_1.Initial_Value = 207;
    defparam VDAC8_1.Strobe_Mode = 0;

	wire [0:0] tmpOE__V3_net;
	wire [0:0] tmpFB_0__V3_net;
	wire [0:0] tmpIO_0__V3_net;
	wire [0:0] tmpINTERRUPT_0__V3_net;

	cy_psoc3_pins_v1_10
		#(.id("81f48a52-bb24-4966-a8fc-0896f0f70640"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		V3
		 (.oe(tmpOE__V3_net),
		  .y({Net_724}),
		  .fb({tmpFB_0__V3_net[0:0]}),
		  .io({tmpIO_0__V3_net[0:0]}),
		  .siovref({Net_725}),
		  .interrupt({tmpINTERRUPT_0__V3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__V3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
