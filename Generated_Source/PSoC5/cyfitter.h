...
/* V3 */
#define V3__0__INTTYPE CYREG_PICU12_INTTYPE2
#define V3__0__MASK 0x04u
#define V3__0__PC CYREG_PRT12_PC2
#define V3__0__PORT 12u
#define V3__0__SHIFT 2u
#define V3__AG CYREG_PRT12_AG
#define V3__BIE CYREG_PRT12_BIE
#define V3__BIT_MASK CYREG_PRT12_BIT_MASK
#define V3__BYP CYREG_PRT12_BYP
#define V3__DM0 CYREG_PRT12_DM0
#define V3__DM1 CYREG_PRT12_DM1
#define V3__DM2 CYREG_PRT12_DM2
#define V3__DR CYREG_PRT12_DR
#define V3__INP_DIS CYREG_PRT12_INP_DIS
#define V3__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU12_BASE
#define V3__MASK 0x04u
#define V3__PORT 12u
#define V3__PRT CYREG_PRT12_PRT
#define V3__PRTDSI__DBL_SYNC_IN CYREG_PRT12_DBL_SYNC_IN
#define V3__PRTDSI__OE_SEL0 CYREG_PRT12_OE_SEL0
#define V3__PRTDSI__OE_SEL1 CYREG_PRT12_OE_SEL1
#define V3__PRTDSI__OUT_SEL0 CYREG_PRT12_OUT_SEL0
#define V3__PRTDSI__OUT_SEL1 CYREG_PRT12_OUT_SEL1
#define V3__PRTDSI__SYNC_OUT CYREG_PRT12_SYNC_OUT
#define V3__PS CYREG_PRT12_PS
#define V3__SHIFT 2u
#define V3__SIO_CFG CYREG_PRT12_SIO_CFG
#define V3__SIO_DIFF CYREG_PRT12_SIO_DIFF
#define V3__SIO_HYST_EN CYREG_PRT12_SIO_HYST_EN
#define V3__SIO_REG_HIFREQ CYREG_PRT12_SIO_REG_HIFREQ
#define V3__SLW CYREG_PRT12_SLW

/* Intr */
#define Intr__0__INTTYPE CYREG_PICU3_INTTYPE1
#define Intr__0__MASK 0x02u
#define Intr__0__PC CYREG_PRT3_PC1
#define Intr__0__PORT 3u
#define Intr__0__SHIFT 1u
#define Intr__AG CYREG_PRT3_AG
#define Intr__AMUX CYREG_PRT3_AMUX
#define Intr__BIE CYREG_PRT3_BIE
#define Intr__BIT_MASK CYREG_PRT3_BIT_MASK
#define Intr__BYP CYREG_PRT3_BYP
#define Intr__CTL CYREG_PRT3_CTL
#define Intr__DM0 CYREG_PRT3_DM0
#define Intr__DM1 CYREG_PRT3_DM1
#define Intr__DM2 CYREG_PRT3_DM2
#define Intr__DR CYREG_PRT3_DR
#define Intr__INP_DIS CYREG_PRT3_INP_DIS
#define Intr__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU3_BASE
#define Intr__LCD_COM_SEG CYREG_PRT3_LCD_COM_SEG
#define Intr__LCD_EN CYREG_PRT3_LCD_EN
#define Intr__MASK 0x02u
#define Intr__PORT 3u
#define Intr__PRT CYREG_PRT3_PRT
#define Intr__PRTDSI__CAPS_SEL CYREG_PRT3_CAPS_SEL
#define Intr__PRTDSI__DBL_SYNC_IN CYREG_PRT3_DBL_SYNC_IN
#define Intr__PRTDSI__OE_SEL0 CYREG_PRT3_OE_SEL0
#define Intr__PRTDSI__OE_SEL1 CYREG_PRT3_OE_SEL1
#define Intr__PRTDSI__OUT_SEL0 CYREG_PRT3_OUT_SEL0
#define Intr__PRTDSI__OUT_SEL1 CYREG_PRT3_OUT_SEL1
#define Intr__PRTDSI__SYNC_OUT CYREG_PRT3_SYNC_OUT
#define Intr__PS CYREG_PRT3_PS
#define Intr__SHIFT 1u
#define Intr__SLW CYREG_PRT3_SLW

/* REDY */
#define REDY__0__INTTYPE CYREG_PICU3_INTTYPE0
#define REDY__0__MASK 0x01u
#define REDY__0__PC CYREG_PRT3_PC0
#define REDY__0__PORT 3u
#define REDY__0__SHIFT 0u
#define REDY__AG CYREG_PRT3_AG
#define REDY__AMUX CYREG_PRT3_AMUX
#define REDY__BIE CYREG_PRT3_BIE
#define REDY__BIT_MASK CYREG_PRT3_BIT_MASK
#define REDY__BYP CYREG_PRT3_BYP
#define REDY__CTL CYREG_PRT3_CTL
#define REDY__DM0 CYREG_PRT3_DM0
#define REDY__DM1 CYREG_PRT3_DM1
#define REDY__DM2 CYREG_PRT3_DM2
#define REDY__DR CYREG_PRT3_DR
#define REDY__INP_DIS CYREG_PRT3_INP_DIS
#define REDY__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU3_BASE
#define REDY__LCD_COM_SEG CYREG_PRT3_LCD_COM_SEG
#define REDY__LCD_EN CYREG_PRT3_LCD_EN
#define REDY__MASK 0x01u
#define REDY__PORT 3u
#define REDY__PRT CYREG_PRT3_PRT
#define REDY__PRTDSI__CAPS_SEL CYREG_PRT3_CAPS_SEL
#define REDY__PRTDSI__DBL_SYNC_IN CYREG_PRT3_DBL_SYNC_IN
#define REDY__PRTDSI__OE_SEL0 CYREG_PRT3_OE_SEL0
#define REDY__PRTDSI__OE_SEL1 CYREG_PRT3_OE_SEL1
#define REDY__PRTDSI__OUT_SEL0 CYREG_PRT3_OUT_SEL0
#define REDY__PRTDSI__OUT_SEL1 CYREG_PRT3_OUT_SEL1
#define REDY__PRTDSI__SYNC_OUT CYREG_PRT3_SYNC_OUT
#define REDY__PS CYREG_PRT3_PS
#define REDY__SHIFT 0u
#define REDY__SLW CYREG_PRT3_SLW
